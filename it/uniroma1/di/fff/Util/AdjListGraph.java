 ...
 *  Description:		utility class to build a graph (by adding and removing edges)
 *  						and count k-cliques therein (used for graphs G+(u))
 *  					
 */
...
public class AdjListGraph implements CliqueCounterGraph {
	...
	public void addEdge (String a, String b) {
		...
		this.addOrientedEdge(a,b);
		this.addOrientedEdge(b,a);
